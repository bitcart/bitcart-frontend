...
export type LocaleModuleRelativePath = string

export type LocaleModuleCatalog = Record<LocaleModuleRelativePath, { messages: LocaleMessages }>

export type LazyLocaleModuleCatalog = Record<
  LocaleModuleRelativePath,
  () => Promise<{ messages: LocaleMessages }>
>
