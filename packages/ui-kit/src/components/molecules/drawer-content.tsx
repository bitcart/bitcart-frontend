...
import { DrawerOverlay, DrawerPortal } from "../atoms/drawer"

export type DrawerContentProps = React.ComponentProps<typeof DrawerPrimitive.Content> & {}

export const DrawerContent: React.FC<DrawerContentProps> = ({ className, children, ...props }) => {
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          `
            ...
            data-[vaul-drawer-direction=top]:mb-24 data-[vaul-drawer-direction=top]:rounded-b-lg
      ...
      >
        <div
          className={`
            bg-muted mt-4 h-2 mx-auto hidden w-[100px] shrink-0 rounded-full
