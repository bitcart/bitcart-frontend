      ...
      <div className="max-w-4xl px-6 py-16 sm:px-8 lg:px-12 mx-auto">
        <div className="prose prose-gray dark:prose-invert text-muted-foreground max-w-none">
          <h1 className="text-3xl font-bold mb-8 pt-8 text-center">
            BITCART PAID PLUGINS PRIVACY POLICY
          </h1>

          <p className="text-muted-foreground mb-8 text-center">Effective date: 2025-03-05</p>

          <h2 className="text-2xl font-semibold mt-12 mb-6">1. Introduction</h2>

          <p className="leading-relaxed mb-6">
            Welcome to <strong>Bitcart Paid Plugins</strong>.
          </p>

          <p className="leading-relaxed mb-6">
            <strong>Bitcart</strong> (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates
            the paid plugins licensing system at <strong>licensing.bitcart.ai</strong> and the
            plugins functionality accessible via your Bitcart instance&apos;s plugins page
          ...
          <p className="leading-relaxed mb-6">
            ...
            <strong>licensing.bitcart.ai</strong> and through your Bitcart instance&apos;s plugins
            page, and explains how we collect, safeguard and disclose information that results from
            your use of our Service.
          </p>

          <p className="leading-relaxed mb-6">
            We use your data to provide and improve the Service, specifically for licensing and
            functionality of paid plugins. By using the Service, you agree to the collection and use
            of information in accordance with this policy. Unless otherwise defined in this Privacy
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">2. Definitions</h2>

          <div className="space-y-4 mb-12">
            <div className="border-ring pl-4 border-l-4">
              <p className="leading-relaxed">
                <strong className="text-accent-foreground font-semibold">SERVICE</strong> means the
                licensing.bitcart.ai website and paid plugins functionality operated by Bitcart.
              </p>
            </div>

            <div className="border-ring pl-4 border-l-4">
              <p className="leading-relaxed">
                <strong className="text-accent-foreground font-semibold">PERSONAL DATA</strong>{" "}
            ...
            <div className="border-ring pl-4 border-l-4">
              <p className="leading-relaxed">
                <strong className="text-accent-foreground font-semibold">USAGE DATA</strong> is data
            ...
            <div className="border-ring pl-4 border-l-4">
              <p className="leading-relaxed">
                <strong className="text-accent-foreground font-semibold">COOKIES</strong> are small
            ...
            <div className="border-ring pl-4 border-l-4">
              <p className="leading-relaxed">
                <strong className="text-accent-foreground font-semibold">DATA CONTROLLER</strong>{" "}
            ...
            <div className="border-ring pl-4 border-l-4">
              <p className="leading-relaxed">
                <strong className="text-accent-foreground font-semibold">DATA SUBJECT</strong> is
            ...
            <div className="border-ring pl-4 border-l-4">
              <p className="leading-relaxed">
                <strong className="text-accent-foreground font-semibold">THE USER</strong> is the
                individual using our Service. The User corresponds to the Data Subject, who is the
                subject of Personal Data.
              </p>
            </div>
          </div>

          <h2 className="text-2xl font-semibold mt-12 mb-6">3. Information Collection and Use</h2>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">4. Types of Data Collected</h2>

          <h3 className="text-xl font-semibold mt-8 mb-4">Personal Data</h3>

          <p className="leading-relaxed mb-6">
            While using our Service, we may ask you to provide us with certain personally
            identifiable information that can be used to contact or identify you (
            <strong>&quot;Personal Data&quot;</strong>) for the purposes of plugin licensing and
            support. Personally identifiable information may include, but is not limited to:
          </p>

          <ul className="space-y-2 mb-6 ml-4 list-inside list-disc">
            <li>Email address</li>
            <li>First name and last name</li>
            <li>License key information</li>
            <li>Server instance identifier</li>
          ...
          <h3 className="text-xl font-semibold mt-8 mb-4">Tracking Cookies Data</h3>
          ...
          <p className="leading-relaxed mb-4">Examples of Cookies we use:</p>
          ...
          <p className="leading-relaxed mb-4">
            0.2. <strong>Preference Cookies:</strong> We use Preference Cookies to remember your
          ...
          <p className="leading-relaxed mb-6">
            0.4. <strong>Advertising Cookies:</strong> Advertising Cookies are used to serve you
            with advertisements that may be relevant to you and your interests.
          </p>

          <h3 className="text-xl font-semibold mt-8 mb-4">Other Data</h3>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">5. Use of Data</h2>

          <p className="leading-relaxed mb-6">
            Bitcart uses the collected data for various purposes related to paid plugins:
          </p>

          <ul className="space-y-2 mb-6 ml-4 list-inside list-disc">
            <li>to provide and maintain our plugin licensing Service;</li>
            <li>to notify you about changes to our Service and plugins;</li>
            <li>to verify plugin licenses and ensure proper functionality;</li>
            <li>to provide plugin support;</li>
            <li>to gather analysis or valuable information so that we can improve our plugins;</li>
            <li>to monitor the usage of our plugins;</li>
            <li>to detect, prevent and address technical issues;</li>
            <li>to fulfil any other purpose for which you provide it;</li>
          </ul>

          <ul className="space-y-2 mb-12 ml-4 list-inside list-disc">
            <li>
              to carry out our obligations and enforce our rights arising from any plugin licenses
              entered into between you and us, including for billing and collection;
            </li>
            <li>
              to provide you with notices about your plugin licenses and/or subscriptions, including
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">6. Retention of Data</h2>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">7. Transfer of Data</h2>
          ...
          <p>
            ...
            that we transfer the data, including Personal Data, to Germany and process it there.
          </p>
          ...
          <p>
            Bitcart will take all the steps reasonably necessary to ensure that your data is treated
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">8. Disclosure of Data</h2>

          <p className="leading-relaxed mb-6">
            We may disclose personal information that we collect, or you provide:
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-3">0.1. Disclosure for Law Enforcement</h3>
          <p className="leading-relaxed mb-6">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-3">0.2. Business Transaction</h3>
          <p className="leading-relaxed mb-6">
          ...
          <ul className="space-y-2 mb-8 ml-4 list-inside list-disc">
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">9. Security of Data</h2>
          <p className="leading-relaxed mb-8">
          ...
          <p className="leading-relaxed mb-4">According to CalOPPA we agree to the following:</p>
          <ul className="space-y-2 mb-6 ml-4 list-inside list-disc">
          ...
          <p>
            <b>
              ...
              without monetary consideration may be considered a &quot;sale&quot; under California
              law. You are the only owner of your Personal Data and can request disclosure or
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">13. Service Providers</h2>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">14. Analytics</h2>

          <p>
            We may use third-party Service Providers to monitor and analyze the use of our Service.
          </p>

          <h2 className="text-2xl font-semibold mt-12 mb-6">15. CI/CD tools</h2>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">16. Behavioral Remarketing</h2>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">17. Payments</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">18. Links to Other Sites</h2>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">19. Children&apos;s Privacy</h2>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">20. Changes to This Privacy Policy</h2>
          ...
          <h2 className="text-2xl font-semibold mt-12 mb-6">21. Contact Us</h2>
